// Source: https://github.com/dotansimha/graphql-code-generator/blob/master/packages/presets/client/src/process-sources.ts

import {
  OperationOrFragment,
  SourceWithOperations,
} from "npm:@graphql-codegen/gql-tag-operations";
import { Source } from "npm:@graphql-tools/utils";
import { FragmentDefinitionNode, OperationDefinitionNode } from "npm:graphql";
